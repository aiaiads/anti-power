...
Manager 窗口无法使用内置 DevTools, 建议使用 9222 + Playwright, 详见 [tests/README.md](../../tests/README.md).
...
- [ ] **Manager 代码块缺少语言标识**
  - 原因: Manager DOM 不提供 `language-xxx` class 或其他可识别语言信息 (上游限制)
  - 备注: 详见 [known-issues.md](../reference/known-issues.md)
